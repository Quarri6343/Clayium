 ...
 */
public final class ClayModularUI implements ISizeProvider {
    ...
    public ClayModularUI(ImmutableBiMap<Integer, Widget> guiWidgets, ImmutableList<Runnable> openListeners, ImmutableList<Runnable> closeListeners, IGuiTexture backgroundPath, int width, int height, IUIHolder holder, EntityPlayer entityPlayer) {
    ...
    public void initWidgets() {
        guiWidgets.values().forEach(widget -> {
            widget.setGui(new ModularUI(guiWidgets,uiOpenCallback,uiCloseCallback,backgroundPath,width,height,holder,entityPlayer));
    ...
    public static class Builder {
        ...
        public Builder progressBar(DoubleSupplier progressSupplier, int x, int y, int width, int height, TextureArea texture, MoveType moveType, ClayRecipeMap<?> clayRecipeMap) {
            return widget(new ClayRecipeProgressWidget(progressSupplier, x, y, width, height, texture, moveType, clayRecipeMap));
        }
