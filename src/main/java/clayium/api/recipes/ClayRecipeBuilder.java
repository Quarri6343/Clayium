...
public class ClayRecipeBuilder<R extends ClayRecipeBuilder<R>> {
    ...
    protected int duration, EUt, tier;
    ...
    protected EnumValidationResult validate() {
        ...
        if (tier < 0) {
            GTLog.logger.error("Tier cannot be less than 0", new IllegalArgumentException());
            if(isCTRecipe) {
                CraftTweakerAPI.logError("DTier cannot be less than 0", new IllegalArgumentException());
            }
            recipeStatus = EnumValidationResult.INVALID;
        }
